			        ...
			        series : [
			            {
			                name:'上周',
			                type:'bar',
			                data:[lastWeekDatas[0], lastWeekDatas[1], lastWeekDatas[2], lastWeekDatas[3]],
			                markPoint : {
			                    data : [
			                        {type : 'max', name: '最大值'},
			                        {type : 'min', name: '最小值'}
			            ...
			            },
			            {
			                name:'本周',
			                type:'bar',
			                data:[thisWeekDatas[0], thisWeekDatas[1], thisWeekDatas[2], thisWeekDatas[3]],
			                markPoint : {
			                    data : [
			                        {type : 'max', name: '最大值'},
			                        {type : 'min', name: '最小值'}
